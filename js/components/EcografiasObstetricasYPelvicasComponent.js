        ...
        <div class="services-section" style="padding-top: 40px; padding-bottom: 60px;">
            <div class="container">
                <div class="section-header text-center" style="margin-bottom: 40px;">
                    ...
                    <h2 style="font-size: 2.5rem; color: var(--primary);">Ecografías Obstétricas y Pélvicas</h2>
                    <p style="margin-top: 20px; color: var(--text-light); max-width: 800px; margin-left: auto; margin-right: auto; font-size: 1.1rem;">
                        Servicios especializados en ecografías obstétricas y pélvicas para el cuidado y seguimiento de tu salud y la de tu bebé.
                    </p>
                </div>

                <div class="tarifa-category-card" style="max-width: 800px; margin: 40px auto 0 auto; background: var(--white); border-radius: 16px; box-shadow: 0 10px 40px rgba(0,0,0,0.05); overflow: hidden; border: 1px solid var(--border);">
