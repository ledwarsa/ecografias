            ...
            <div class="premium-card">
                <div class="premium-content">
                    ...
                    <div class="premium-buttons" style="display: flex; gap: 1rem; flex-wrap: wrap; margin-top: 1.5rem;">
                        <button class="btn btn-white-outline">Conocer el examen</button>
                        <a href="https://wa.me/" target="_blank" class="btn" style="background-color: #25d366; color: white; border: 2px solid #25d366; border-radius: 5px; padding: 0.8rem 2rem; font-weight: 600; display: inline-flex; align-items: center; gap: 0.5rem; text-decoration: none; transition: all 0.3s ease;">
